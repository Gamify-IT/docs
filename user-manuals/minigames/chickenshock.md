...
![main menu screenshot](assets/chickenshock_main_menu.png)
When entering the game, the user is presented with main menu.

![game screenshot](assets/chickenshock_game.png)
...
![end screen screenshot](assets/chickenshock_end_screen.png)
